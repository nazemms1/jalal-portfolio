    ...
    <section className={styles.hero} id="hero">
      <div className={styles.container}>
        ...
        <h1 className={styles.name}>
          Jalal <span>Al-Nabelsi</span>
        </h1>

        <h2 className={styles.title}>
          <GlitchText words={TITLES} interval={3200} />
        </h2>

        <p className={styles.intro}>
          Innovative <strong>AI engineer</strong> and{" "}
          <strong>front-end developer</strong> delivering smart solutions
          for impactful software creation.
        </p>
